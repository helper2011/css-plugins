...
#include "funcommands/freeadmin.sp"
...
void RegisterCmds()
{
	RegAdminCmd("sm_beacon", Command_Beacon, ADMFLAG_CUSTOM1, "sm_beacon <#userid|name> [0/1]");
	RegAdminCmd("sm_timebomb", Command_TimeBomb, ADMFLAG_SLAY, "sm_timebomb <#userid|name> [0/1]");
	RegAdminCmd("sm_burn", Command_Burn, ADMFLAG_CUSTOM1, "sm_burn <#userid|name>");
	RegAdminCmd("sm_firebomb", Command_FireBomb, ADMFLAG_SLAY, "sm_firebomb <#userid|name> [0/1]");
	RegAdminCmd("sm_freeze", Command_Freeze, ADMFLAG_CUSTOM1, "sm_freeze <#userid|name>");
	...
	RegAdminCmd("sm_drug", Command_Drug, ADMFLAG_CUSTOM1, "sm_drug <#userid|name> [0/1]");
	RegAdminCmd("sm_slap", Command_Slap, ADMFLAG_CUSTOM1, "sm_slap <#userid|name>");
}
...
public void OnAdminMenuReady(Handle aTopMenu)
{
	...
	{
		hTopMenu.AddItem("sm_beacon", AdminMenu_Beacon, player_commands, "sm_beacon", ADMFLAG_CUSTOM1);
		hTopMenu.AddItem("sm_timebomb", AdminMenu_TimeBomb, player_commands, "sm_timebomb", ADMFLAG_SLAY);
		hTopMenu.AddItem("sm_burn", AdminMenu_Burn, player_commands, "sm_burn", ADMFLAG_CUSTOM1);
		hTopMenu.AddItem("sm_firebomb", AdminMenu_FireBomb, player_commands, "sm_firebomb", ADMFLAG_SLAY);
		hTopMenu.AddItem("sm_freeze", AdminMenu_Freeze, player_commands, "sm_freeze", ADMFLAG_CUSTOM1);
		...
		hTopMenu.AddItem("sm_drug", AdminMenu_Drug, player_commands, "sm_drug", ADMFLAG_CUSTOM1);
		hTopMenu.AddItem("sm_slap", AdminMenu_Slap, player_commands, "sm_slap", ADMFLAG_CUSTOM1);
	}
}
...
{
	FreeAdmin_OnClientPutInServer(iClient);
}

public void OnClientDisconnect(int iClient)
{
	FreeAdmin_OnClientDisconnect(iClient);
}